...
public class PermissionServiceImpl implements PermissionService {
    ...
    public PermissionDO selectPermissionByRequest(String requestKey) {
        ...
        LOGGER.info("==004===============uri:{}==========", uri);
        List<PermissionDO> matchPermissions = permissionDOS.stream().filter(t -> {
            LOGGER.info("+++++++++++++++++++++++++" + t.getPath());
            return matcher.match(t.getPath(), uri);
